...
import com.example.datarencang.databinding.ActivityUpdateDataBinding
...
class UpdateData : AppCompatActivity() {
    ...
    private fun updateTeman(teman: data_rencang ) {
        val userID = auth!!.uid
        val getKey = intent.extras!!.getString("getPrimaryKey")
        database!!.child("Admin").child(userID!!).child("DataRencang").child(getKey!!)
            .setValue(teman)
