...
import com.example.datarencang.databinding.ActivityMainBinding
        ...
        when (p0?.getId()){
            R.id.save ->    {
                ...
                if (isEmpty(getNama) || isEmpty(getAlamat) || isEmpty(getNoHP)){
                    ...
                    getReference.child("Admin").child(getUserID).child("DataRencang").push()
                        .setValue(data_rencang  (getNama,getAlamat,getNoHP))
